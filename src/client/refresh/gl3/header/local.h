...
enum {
	...
	GL3_ATTRIB_QCOORD     = 6  // perspective correction for 2D trapezoids
};
...
extern void GL3_Draw_PicScaledCol(int x, int y, const char *pic, float factor, const float color[3]);
