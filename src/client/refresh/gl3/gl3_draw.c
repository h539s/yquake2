...
GL3_Draw_InitLocal(void)
{
	...
	qglVertexAttribPointer(GL3_ATTRIB_POSITION, 2, GL_FLOAT, GL_FALSE, 5*sizeof(float), 0);

	glEnableVertexAttribArray(GL3_ATTRIB_TEXCOORD);
	qglVertexAttribPointer(GL3_ATTRIB_TEXCOORD, 2, GL_FLOAT, GL_FALSE, 5*sizeof(float), 2*sizeof(float));

	glEnableVertexAttribArray(GL3_ATTRIB_QCOORD);
	qglVertexAttribPointer(GL3_ATTRIB_QCOORD, 1, GL_FLOAT, GL_FALSE, 5*sizeof(float), 4*sizeof(float));
